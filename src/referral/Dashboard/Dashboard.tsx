        ...
        <MainDashboardBlock>
          <MainDashboardBlockRow>
            ...
            <div>
              ...
              <Text fontSize="24px" color="#fff" ml={16}>
                {totalData[0].value}
              </Text>
            </div>
          </MainDashboardBlockRow>
          <MainDashboardBlockRow>
            ...
            <div>
              <Text ml={16} fontSize="12px" fontWeight="700" color="#749BD8">
                {totalData[1].title}
              </Text>
              <Text ml={16} fontSize="24px" color="#fff">
                {totalData[1].value}
              </Text>
            </div>
          </MainDashboardBlockRow>
        ...
        <DashboardInfoContainer>
          {data.map((item) => (
            <DashboardInfoRow key={item.id}>
              <Text fontSize="12px" color="#749BD8" fontWeight="700">
                {item.title}
              </Text>
              <Text fontSize="18px" color="#fff" fontWeight="800">
                {item.value}
              </Text>
            </DashboardInfoRow>
          ))}
