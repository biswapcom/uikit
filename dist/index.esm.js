...
//   }
// `;
var LinkLabel = styled.div(templateObject_1$e || (templateObject_1$e = __makeTemplateObject(["\n  color: ", ";\n  transition: color 0.4s;\n  flex-grow: 1;\n\n  &:hover {\n    color: ", ";\n  }\n"], ["\n  color: ", ";\n  transition: color 0.4s;\n  flex-grow: 1;\n\n  &:hover {\n    color: ", ";\n  }\n"])), function (_a) {
...
var Logo = function (_a) {
    ...
    var innerLogo = (React.createElement(React.Fragment, null, isPushed ?
        React.createElement(React.Fragment, null,
            React.createElement(Icon$M, { className: "mobile-icon" }),
            React.createElement(LogoWithText, { className: "desktop-icon", isDark: isDark })) :
        React.createElement(Icon$M, { className: "mobile-icon" })));
    return (React.createElement("div", null, isAbsoluteUrl ? (React.createElement(StyledLink, { as: "a", href: href, "aria-label": "Pancake home page" }, innerLogo)) : (React.createElement(StyledLink, { to: href, "aria-label": "Pancake home page" }, innerLogo))));
};
...
var Panel = function (props) {
    ...
    return (React.createElement(StyledPanel, { isPushed: isPushed, showMenu: showMenu },
        React.createElement(Logo$1, { isPushed: isPushed, isDark: isDark, href: "http" }),
        React.createElement(PanelBody, __assign({}, props)),
        React.createElement(PanelFooter, __assign({}, props))));
};
var templateObject_1$8;

var Wrapper$1 = styled.footer(templateObject_1$7 || (templateObject_1$7 = __makeTemplateObject(["\n  padding-left: ", ";\n  color: #fff;\n  background: ", ";\n"], ["\n  padding-left: ", ";\n  color: #fff;\n  background: ", ";\n"])), function (_a) {
    var isPushed = _a.isPushed;
    return (isPushed ? SIDEBAR_WIDTH_FULL : SIDEBAR_WIDTH_REDUCED) + "px";
}, function (_a) {
    var theme = _a.theme;
...
var Footer = function (props) {
    ...
    return (React.createElement(Wrapper$1, { isPushed: isPushed }, "s"));
};
    ...
    return (React.createElement(Wrapper, null,
        React.createElement(BodyWrapper, null,
            React.createElement(StyledNav, { showMenu: showMenu, isPushed: isPushed },
                React.createElement(TogglePanel, { isPushed: isPushed, togglePush: function () { return setIsPushed(function (prevState) { return !prevState; }); }, isDark: isDark, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/" }),
        ...
        React.createElement(Footer, { isPushed: isPushed })));
};
