...
var templateObject_1$12, templateObject_2$u, templateObject_3$a;
...
var templateObject_1$Z, templateObject_2$t, templateObject_3$9, templateObject_4$7, templateObject_5$5;
...
var templateObject_1$Y, templateObject_2$s, templateObject_3$8;
...
var BackgroundImage = function (_a) {
    ...
    return React.createElement(Wrapper$d, __assign({ ref: imgRef }, otherProps));
};
...
var Image = function (_a) {
    ...
    return (React.createElement(Wrapper$d, __assign({ ref: imgRef }, otherProps), isLoaded ? React.createElement(StyledImage, { src: src, alt: alt }) : React.createElement(Placeholder, null)));
};
...
var templateObject_1$u, templateObject_2$l, templateObject_3$7, templateObject_4$6, templateObject_5$4, templateObject_6, templateObject_7;
...
var RotatingPancakeIcon = styled(Icon$t)(templateObject_4$5 || (templateObject_4$5 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate$1);
var FloatingPanIcon = styled(Icon$u)(templateObject_5$3 || (templateObject_5$3 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
...
var templateObject_1$s, templateObject_2$j, templateObject_3$5, templateObject_4$4, templateObject_5$2;
...
var templateObject_1$r, templateObject_2$i, templateObject_3$4;
...
var Badge = function (_a) {
    ...
    return (React.createElement(Wrapper$c, { badgeType: badgeType },
...
var templateObject_1$p, templateObject_2$h, templateObject_3$3, templateObject_4$3;
...
var NavSocial = function () {
    ...
    return (React.createElement(Wrapper$b, null, socials.map(function (social) {
...
var templateObject_1$l, templateObject_2$g, templateObject_3$2, templateObject_4$2, templateObject_5$1;
...
var Logo$2 = function (_a) {
    ...
    return (React.createElement(Wrapper$a, null,
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" },
            React.createElement(Icon$q, { width: "24px", color: "textSubtle" })),
        React.createElement(HeaderMobileLogo, { href: "/" },
            React.createElement(Icon$V, { width: "32px" })),
...
var LoaderAnimation = styled(Icon$3)(templateObject_1$h || (templateObject_1$h = __makeTemplateObject(["\n  @keyframes loader {\n    from {\n      transform: rotate(0deg);\n    }\n    to {\n      transform: rotate(360deg);\n    }\n  }\n  \n  animation: loader 2s linear infinite;\n"], ["\n  @keyframes loader {\n    from {\n      transform: rotate(0deg);\n    }\n    to {\n      transform: rotate(360deg);\n    }\n  }\n  \n  animation: loader 2s linear infinite;\n"])));
...
var Icon$2 = styled.div(templateObject_2$b || (templateObject_2$b = __makeTemplateObject(["\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  width: 24px;\n  min-width: 24px;\n  height: 24px;\n  margin-right: 8px;\n  border-radius: 8px;\n  background-color: ", ";\n\n  .swapArrow {\n    width: 12px;\n    height: auto;\n  }\n"], ["\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  width: 24px;\n  min-width: 24px;\n  height: 24px;\n  margin-right: 8px;\n  border-radius: 8px;\n  background-color: ", ";\n\n  .swapArrow {\n    width: 12px;\n    height: auto;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.success;
});
...
var templateObject_1$g, templateObject_2$b, templateObject_3$1, templateObject_4$1;
...
var Inner$1 = styled.div(templateObject_2$a || (templateObject_2$a = __makeTemplateObject(["\n  padding: 16px;\n  border-radius: 16px;\n  background-color: ", ";\n"], ["\n  padding: 16px;\n  border-radius: 16px;\n  background-color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.dropDown;
});
var PanelFooter2 = function (props) {
    ...
    return (React.createElement(Wrapper$8, { isPushed: isPushed, footerTitle: footerTitle, isDark: isDark, deals: deals },
...
var Logo = function (_a) {
    ...
    var innerLogo = (React.createElement(React.Fragment, null, isPushed ? (React.createElement(React.Fragment, null,
        ...
        React.createElement(LogoWithText, { className: "desktop-icon", isDark: isDark }))) : (React.createElement(Icon$V, { className: "mobile-icon" }))));
    return (React.createElement(Wrapper$7, { isPushed: isPushed, isDark: isDark, href: href }, isAbsoluteUrl ? (React.createElement(StyledLink$1, { as: "a", href: href, "aria-label": "Pancake home page" }, innerLogo)) : (React.createElement(StyledLink$1, { to: href, "aria-label": "Pancake home page" }, innerLogo))));
};
...
var MenuBtnDesktop = styled.div(templateObject_2$8 || (templateObject_2$8 = __makeTemplateObject(["\n  display: none;\n  justify-content: center;\n  align-items: center;\n  width: 24px;\n  height: 24px;\n  border-radius: 50%;\n  background-color: ", ";\n  cursor: pointer;\n  position: absolute;\n  top: 24px;\n  right: -12px;\n  transform: ", ";\n\n  ", " {\n    display: flex;\n    opacity: ", ";\n    transition: opacity 0.3s ease;\n  }\n"], ["\n  display: none;\n  justify-content: center;\n  align-items: center;\n  width: 24px;\n  height: 24px;\n  border-radius: 50%;\n  background-color: ", ";\n  cursor: pointer;\n  position: absolute;\n  top: 24px;\n  right: -12px;\n  transform: ", ";\n\n  ", " {\n    display: flex;\n    opacity: ", ";\n    transition: opacity 0.3s ease;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.dropDown;
}, function (_a) {
    var isPushed = _a.isPushed;
...
var Panel = function (props) {
    ...
    return (React.createElement(StyledPanel, { isPushed: isPushed, showMenu: showMenu },
        React.createElement(MenuBtnDesktop, { className: "menuBtnDesktop", isPushed: isPushed, onClick: togglePush },
            React.createElement(Icon$8, { width: "16px", color: "contrast" })),
...
var UserBlock = function (_a) {
    ...
    return (React.createElement("div", null, account ? (React.createElement(WalletWrap, null,
        React.createElement(Button, { variant: pendingTransactions ? "success" : "primary", scale: "sm", onClick: function () {
            ...
            React.createElement(Icon$9, __assign({}, iconProps, { mr: "8px" })),
...
var BSWPrice = function (_a) {
    ...
    return (React.createElement(Wrapper$4, null,
        React.createElement(Icon$V, { className: "logo" }),
...
export { Icon$1g as AddIcon, Alert, Icon$1f as ArrowBackIcon, Icon$1e as ArrowDownIcon, Icon$1d as ArrowDropDownIcon, Icon$1c as ArrowDropUpIcon, Icon$1b as ArrowForwardIcon, Icon$1a as ArrowUpIcon, Icon$19 as AutoRenewIcon, BackgroundImage, Badge, Banner, BannerBody, BannerTitle, GridLayout$1 as BaseLayout, Icon$18 as BinanceIcon, Icon$1i as BlockIcon, Box, Breadcrumbs, Icon$17 as BunnyPlaceholderIcon, Button, ButtonMenu, ButtonMenuItem, Icon$15 as CalculateIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$16 as CardViewIcon, GridLayout as CardsLayout, Checkbox, Icon$1k as CheckmarkCircleIcon, Icon$14 as CheckmarkIcon, Icon$13 as ChevronDownIcon, Icon$12 as ChevronLeftIcon, Icon$11 as ChevronRightIcon, Icon$10 as ChevronUpIcon, Icon$$ as CloseIcon, Icon$_ as CogIcon, Icon$Z as CommunityIcon, ConnectorNames, Icon$Y as CopyIcon, Icon$z as DownloadIcon, Dropdown, Icon$1j as ErrorIcon, FallingBunnies, FarmCard, FarmCardBody, FarmCardHead, Flex, Heading, Icon$X as HelpIcon, IconButton, Image, Icon$1h as InfoIcon, Input$1 as Input, Link, LinkExternal, Icon$y as LinkIcon, Icon$W as ListViewIcon, Icon$V as LogoIcon, Icon$U as LogoRoundIcon, Menu, Icon$T as MetamaskIcon, Icon$S as MinusIcon, Modal, ModalProvider, Icon$R as NoProfileAvatarIcon, NotificationDot, Icon$Q as OpenNewIcon, Icon$O as PancakeRoundIcon, Icon$P as PancakesIcon, Icon$N as PlayCircleOutlineIcon, Icon$M as PrizeIcon, Progress, Icon$J as ProgressBunny, Radio, Icon$L as RemoveIcon, ResetCSS, Icon$D as SearchIcon, Skeleton, Slider, Spinner, Svg, Icon$C as SwapVertIcon, Icon$B as SyncAltIcon, Tag, Icon$x as TelegramIcon, Text, Icon$G as Ticket, Icon$F as TicketRound, Icon$E as TimerIcon, ToastContainer, Toggle, Icon$w as TwitterIcon, Icon$K as VerifiedIcon, Icon$I as WaitIcon, Icon$A as WarningIcon, Icon$H as Won, variants$2 as alertVariants, byTextAscending, byTextDescending, connectorLocalStorageKey, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, types as toastTypes, useKonamiCheatCode, useMatchBreakpoints, useModal, useParticleBurst, useTable, useWalletModal };
