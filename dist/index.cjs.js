...
var StyledBannerLeft = styled__default['default'].div(templateObject_3$a || (templateObject_3$a = __makeTemplateObject(["\n  width: 50%;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n"], ["\n  width: 50%;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n"])));
...
styled__default['default'].img(templateObject_3$9 || (templateObject_3$9 = __makeTemplateObject(["\n  position: absolute;\n"], ["\n  position: absolute;\n"])));
...
var DropDown = styled__default['default'].div(templateObject_3$4 || (templateObject_3$4 = __makeTemplateObject(["\n  display: none;\n  position: absolute;\n  border-radius: 8px;\n  padding: 8px;\n  background-color: ", ";\n  top: ", ";\n  bottom: ", ";\n  left: 50%;\n  transform: translateX(-50%);\n\n  &:before {\n    display: block;\n    content: \"\";\n    width: 8px;\n    height: 8px;\n    position: absolute;\n    top: ", ";\n    bottom: ", ";\n    left: 50%;\n    transform: translateX(-50%) rotate(45deg);\n    background-color: ", ";\n  }\n\n  &.active {\n    display: block;\n  }\n"], ["\n  display: none;\n  position: absolute;\n  border-radius: 8px;\n  padding: 8px;\n  background-color: ", ";\n  top: ", ";\n  bottom: ", ";\n  left: 50%;\n  transform: translateX(-50%);\n\n  &:before {\n    display: block;\n    content: \"\";\n    width: 8px;\n    height: 8px;\n    position: absolute;\n    top: ", ";\n    bottom: ", ";\n    left: 50%;\n    transform: translateX(-50%) rotate(45deg);\n    background-color: ", ";\n  }\n\n  &.active {\n    display: block;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.dropDown;
}, function (_a) {
    var isSidebar = _a.isSidebar;
...
var Info = styled__default['default'].div(templateObject_3$3 || (templateObject_3$3 = __makeTemplateObject(["\n  flex-grow: 1;\n"], ["\n  flex-grow: 1;\n"])));
...
var AccountModal = function (_a) {
    ...
    var _e = React.useState(true), isPendingTransaction = _e[0], setIsPendingTransactions = _e[1];
    React.useEffect(function () {
        if (account) {
                ...
                account &&
                    ...
                    recentTransaction.map(function (sortedRecentTransaction) {
                        ...
                        return (React__default['default'].createElement(React__default['default'].Fragment, null, hash && (React__default['default'].createElement(Flex, { key: hash, alignItems: "center", justifyContent: "space-between", mb: "4px" },
                            React__default['default'].createElement(LinkExternal, { href: "https://bscscan.com/tx/" + hash, color: color }, summary !== null && summary !== void 0 ? summary : hash),
                            isPendingTransaction ? React__default['default'].createElement(Icon$7, null) : icon))));
                    })))),
    ...
    return (React__default['default'].createElement(Wrapper$1, { isPushed: isPushed },
        React__default['default'].createElement(GridRow, null,
            ...
            React__default['default'].createElement(BtnUp, { onClick: function () { return reactScroll.animateScroll.scrollToTop(); } },
                React__default['default'].createElement(Icon$1m, { color: 'white' })))));
};
