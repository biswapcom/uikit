...
var RotatingPancakeIcon = styled__default['default'](Icon$C)(templateObject_4$7 || (templateObject_4$7 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate$1);
var FloatingPanIcon = styled__default['default'](Icon$D)(templateObject_5$5 || (templateObject_5$5 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
            ...
            return (React__default['default'].createElement(DropDownWrap, { key: social.label, ref: ref },
                ...
                isOpen && (React__default['default'].createElement(DropDown, { className: "" + (isOpen && "active"), isSidebar: isSidebar },
                    React__default['default'].createElement(DropDownLink, { key: social.items.channel.label, href: social.items.channel.href, "aria-label": social.label },
                        React__default['default'].createElement(Icon$1a, { width: "14px", mr: "8px" }),
...
var Icon$4 = styled__default['default'].div(templateObject_2$e || (templateObject_2$e = __makeTemplateObject(["\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  width: 24px;\n  min-width: 24px;\n  height: 24px;\n  margin-right: 8px;\n  border-radius: 8px;\n  background-color: ", ";\n\n  .swapArrow {\n    width: 12px;\n    height: auto;\n  }\n"], ["\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  width: 24px;\n  min-width: 24px;\n  height: 24px;\n  margin-right: 8px;\n  border-radius: 8px;\n  background-color: ", ";\n\n  .swapArrow {\n    width: 12px;\n    height: auto;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.success;
});
...
var AuditInfo = function () {
    return (React__default['default'].createElement(Wrapper$7, { href: 'https://www.certik.org/projects/biswap', target: "_blank" },
        React__default['default'].createElement(Icon$9, { color: "success", mr: "7px" }),
...
var ConnectMetamask = function (props) {
    ...
    return (React__default['default'].createElement(Wrapper$5, null,
        React__default['default'].createElement(Icon$18, { width: "24px", mx: "7px" }),
    ...
    return (React__default['default'].createElement(Wrapper$1, { isPushed: isPushed },
        React__default['default'].createElement(GridRow, null,
            ...
            React__default['default'].createElement(BtnUp, { onClick: function () { return reactScroll.animateScroll.scrollToTop(); } },
                React__default['default'].createElement(Icon$1r, { color: 'white' })))));
};
    ...
    return (React__default['default'].createElement(reactTransitionGroup.CSSTransition, __assign({ timeout: 250, style: style }, props),
        React__default['default'].createElement(StyledToast, { onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave },
            ...
            React__default['default'].createElement(Alert, { style: { padding: '16px 0 0 0' }, title: title, variant: alertTypeMap[type], onClick: handleRemove },
                actions ? (React__default['default'].createElement(AlertWrapper, null,
...
var ToastContainer = function (_a) {
    ...
    return (React__default['default'].createElement(StyledToastContainer, null,
        toasts.length && (React__default['default'].createElement(Button, { onClick: function () { return toasts.forEach(function (item, index) { return setTimeout(function () { return onRemove(item.id); }, index * 10); }); } })),
        React__default['default'].createElement(reactTransitionGroup.TransitionGroup, null, toasts.map(function (toast, index) {
            ...
            if (index === 0) {
                return (React__default['default'].createElement(Toast, { handleRemove: handleRemove, handleMouseEnter: handleMouseEnter, handleMouseLeave: handleMouseLeave, progress: progress, key: toast.id, toast: toast, zIndex: zIndex, ttl: ttl, removeButtonPosition: removeButtonPosition, clearAll: clearAll, style: { top: top + "px", zIndex: zIndex } }));
            }
