...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Wrapper$3, null,
        React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" },
            React__default['default'].createElement(Icon$T, { width: "24px", color: "textSubtle" })),
...
var Icon$1a = styled__default['default'].div(templateObject_2$i || (templateObject_2$i = __makeTemplateObject(["\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  width: 24px;\n  min-width: 24px;\n  height: 24px;\n  margin-right: 8px;\n  border-radius: 8px;\n  background-color: ", ";\n\n  .swapArrow {\n    width: 12px;\n    height: auto;\n  }\n"], ["\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  width: 24px;\n  min-width: 24px;\n  height: 24px;\n  margin-right: 8px;\n  border-radius: 8px;\n  background-color: ", ";\n\n  .swapArrow {\n    width: 12px;\n    height: auto;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.success;
});
...
var Panel = function (props) {
    ...
    return (React__default['default'].createElement(StyledPanel, { isPushed: isPushed, showMenu: showMenu },
        React__default['default'].createElement(MenuBtnDesktop, { className: "menuBtnDesktop", isPushed: isPushed, onClick: togglePush },
            React__default['default'].createElement(Icon$19, { width: "16px", color: "contrast" })),
...
var UserBlock = function (_a) {
    ...
    return (React__default['default'].createElement("div", null, account ? (React__default['default'].createElement(WalletWrap, null,
        ...
        React__default['default'].createElement(Button, { scale: "sm", onClick: function () {
            ...
            React__default['default'].createElement(Icon$18, __assign({}, iconProps, { mr: "8px" })),
