...
var templateObject_1$18, templateObject_2$x, templateObject_3$j;
...
//   }
// `;
var Title$5 = styled__default['default'].div(templateObject_1$13 || (templateObject_1$13 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  font-weight: 600;\n  font-size: 16px;\n  margin-bottom: 8px;\n\n  svg {\n    margin-right: 8px;\n    fill: ", ";\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  font-weight: 600;\n  font-size: 16px;\n  margin-bottom: 8px;\n\n  svg {\n    margin-right: 8px;\n    fill: ", ";\n  }\n"])), getThemeColor);
...
var templateObject_1$13, templateObject_2$w, templateObject_3$i, templateObject_4$c, templateObject_5$b;

var StyledBanner = styled__default['default'].div(templateObject_1$12 || (templateObject_1$12 = __makeTemplateObject(["\n  padding: 32px;\n  border-radius: 24px;\n  background: ", ";\n  display: flex;\n"], ["\n  padding: 32px;\n  border-radius: 24px;\n  background: ", ";\n  display: flex;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.gradients.cardBlue;
});
var StyledBannerBoby = styled__default['default'].div(templateObject_2$v || (templateObject_2$v = __makeTemplateObject(["\n  width: ", ";\n  align-items: ", ";\n  display: flex;\n  flex-direction: column;\n"], ["\n  width: ", ";\n  align-items: ", ";\n  display: flex;\n  flex-direction: column;\n"])), function (_a) {
    var large = _a.large;
    return (large ? "50%" : "100%");
}, function (_a) {
    var large = _a.large;
...
var StyledBannerLeft = styled__default['default'].div(templateObject_3$h || (templateObject_3$h = __makeTemplateObject(["\n  width: 50%;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n"], ["\n  width: 50%;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n"])));
...
var templateObject_1$12, templateObject_2$v, templateObject_3$h;

var BannerBody = styled__default['default'].p(templateObject_1$11 || (templateObject_1$11 = __makeTemplateObject(["\n  color: ", ";\n  margin-bottom: 24px;\n  font-weight: 900;\n  min-height: 64px;\n  font-size: 26px;\n  display: -webkit-box;\n  -webkit-line-clamp: 3;\n  -webkit-box-orient: vertical;\n  overflow: hidden;\n"], ["\n  color: ", ";\n  margin-bottom: 24px;\n  font-weight: 900;\n  min-height: 64px;\n  font-size: 26px;\n  display: -webkit-box;\n  -webkit-line-clamp: 3;\n  -webkit-box-orient: vertical;\n  overflow: hidden;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.warning;
});
var templateObject_1$11;

var BannerTitle = styled__default['default'].h2(templateObject_1$10 || (templateObject_1$10 = __makeTemplateObject(["\n  color: ", ";\n  min-height: 32px;\n  margin-bottom: 24px;\n  display: -webkit-box;\n  -webkit-line-clamp: 2;\n  -webkit-box-orient: vertical;\n  overflow: hidden;\n"], ["\n  color: ", ";\n  min-height: 32px;\n  margin-bottom: 24px;\n  display: -webkit-box;\n  -webkit-line-clamp: 2;\n  -webkit-box-orient: vertical;\n  overflow: hidden;\n"])), function (_a) {
    var theme = _a.theme;
...
var Container$3 = styled__default['default'].div(templateObject_2$t || (templateObject_2$t = __makeTemplateObject(["\n  position: relative;\n  &:hover ", ", &:focus-within ", " {\n    display: flex;\n  }\n"], ["\n  position: relative;\n  &:hover ", ", &:focus-within ", " {\n    display: flex;\n  }\n"])), DropdownContent, DropdownContent);
...
var templateObject_1$S, templateObject_2$t;
...
var StyledFarmCard = styled__default['default'].div(templateObject_1$Q || (templateObject_1$Q = __makeTemplateObject(["\n  position: relative;\n  padding: 24px;\n  border-radius: 16px;\n  background-color: #fff;\n  display: flex;\n  flex-direction: column;\n\n  // &:before {\n  //   content: \"New\";\n  //   display: ", ";\n  //   color: #fff;\n  //   background-color: #1dc872;\n  //   border-radius: 16px;\n  //   position: absolute;\n  //   top: 12px;\n  //   right: 12px;\n  //   font-size: 10px;\n  //   padding: 5px 10px;\n  //   text-align: center;\n  //   min-width: 45px;\n  // }\n"], ["\n  position: relative;\n  padding: 24px;\n  border-radius: 16px;\n  background-color: #fff;\n  display: flex;\n  flex-direction: column;\n\n  // &:before {\n  //   content: \"New\";\n  //   display: ", ";\n  //   color: #fff;\n  //   background-color: #1dc872;\n  //   border-radius: 16px;\n  //   position: absolute;\n  //   top: 12px;\n  //   right: 12px;\n  //   font-size: 10px;\n  //   padding: 5px 10px;\n  //   text-align: center;\n  //   min-width: 45px;\n  // }\n"])), function (_a) {
    var isNew = _a.isNew;
...
var StyledFarmCardHead = styled__default['default'].div(templateObject_1$P || (templateObject_1$P = __makeTemplateObject(["\n  display: grid;\n  grid-template-columns: 70px 1fr;\n  column-gap: 8px;\n  margin-bottom: 24px;\n\n  & > img {\n    grid-row: 1 / 3;\n    grid-column: 1 / 2;\n    position: relative;\n    width: 40px;\n    height: 40px;\n    border-radius: 50%;\n\n    &:nth-child(1) {\n      box-shadow: 0 0 0 3px #fff;\n      z-index: 2;\n    }\n    &:nth-child(2) {\n      margin-left: 30px;\n      z-index: 1;\n    }\n  }\n\n  & > p {\n    align-self: center;\n    grid-column: 2 / 3;\n    font-weight: 900;\n    font-size: 18px;\n    color: ", ";\n\n    display: -webkit-box;\n    -webkit-line-clamp: 1;\n    -webkit-box-orient: vertical;\n    overflow: hidden;\n  }\n\n  & > span {\n    align-self: center;\n    grid-column: 2 / 3;\n    font-size: 12px;\n    color: ", ";\n\n    display: -webkit-box;\n    -webkit-line-clamp: 1;\n    -webkit-box-orient: vertical;\n    overflow: hidden;\n  }\n"], ["\n  display: grid;\n  grid-template-columns: 70px 1fr;\n  column-gap: 8px;\n  margin-bottom: 24px;\n\n  & > img {\n    grid-row: 1 / 3;\n    grid-column: 1 / 2;\n    position: relative;\n    width: 40px;\n    height: 40px;\n    border-radius: 50%;\n\n    &:nth-child(1) {\n      box-shadow: 0 0 0 3px #fff;\n      z-index: 2;\n    }\n    &:nth-child(2) {\n      margin-left: 30px;\n      z-index: 1;\n    }\n  }\n\n  & > p {\n    align-self: center;\n    grid-column: 2 / 3;\n    font-weight: 900;\n    font-size: 18px;\n    color: ", ";\n\n    display: -webkit-box;\n    -webkit-line-clamp: 1;\n    -webkit-box-orient: vertical;\n    overflow: hidden;\n  }\n\n  & > span {\n    align-self: center;\n    grid-column: 2 / 3;\n    font-size: 12px;\n    color: ", ";\n\n    display: -webkit-box;\n    -webkit-line-clamp: 1;\n    -webkit-box-orient: vertical;\n    overflow: hidden;\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var StyledFarmCardBody = styled__default['default'].div(templateObject_1$O || (templateObject_1$O = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n\n  & > p {\n    flex: 1 1;\n    color: ", ";\n    font-size: 20px;\n    font-weight: 900;\n\n    display: -webkit-box;\n    -webkit-line-clamp: 1;\n    -webkit-box-orient: vertical;\n    overflow: hidden;\n  }\n\n  & > div {\n      position: absolute;\n      top: 12px;\n      right: 12px;\n  }\n"], ["\n  display: flex;\n  align-items: center;\n\n  & > p {\n    flex: 1 1;\n    color: ", ";\n    font-size: 20px;\n    font-weight: 900;\n\n    display: -webkit-box;\n    -webkit-line-clamp: 1;\n    -webkit-box-orient: vertical;\n    overflow: hidden;\n  }\n\n  & > div {\n      position: absolute;\n      top: 12px;\n      right: 12px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var Text = styled__default['default'].span(templateObject_1$N || (templateObject_1$N = __makeTemplateObject(["\n  display: block;\n  color: ", ";\n  font-size: ", ";\n  vertical-align: middle;\n  font-weight: ", ";\n  line-height: ", ";\n  ", "\n  ", "\n  ", "\n"], ["\n  display: block;\n  color: ", ";\n  font-size: ", ";\n  vertical-align: middle;\n  font-weight: ", ";\n  line-height: ", ";\n  ", "\n  ", "\n  ", "\n"])), getColor, getFontSize, function (_a) {
    var bold = _a.bold;
    return (bold ? 600 : 400);
}, function (_a) {
...
var Wrapper$h = styled__default['default'].div(templateObject_1$L || (templateObject_1$L = __makeTemplateObject(["\n  position: relative;\n  background-position: center center;\n  background-repeat: no-repeat;\n  background-size: cover;\n  height: ", "px;\n  max-width: ", "px;\n  max-height: ", "px;\n  width: 100%;\n  padding-top: ", "%;\n  ", "\n"], ["\n  position: relative;\n  background-position: center center;\n  background-repeat: no-repeat;\n  background-size: cover;\n  height: ", "px;\n  max-width: ", "px;\n  max-height: ", "px;\n  width: 100%;\n  padding-top: ", "%;\n  ", "\n"])), function (_a) {
...
var Placeholder = styled__default['default'].div(templateObject_2$r || (templateObject_2$r = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n"])));
...
var GridLayout$1 = styled__default['default'].div(templateObject_1$I || (templateObject_1$I = __makeTemplateObject(["\n  display: grid;\n  grid-template-columns: repeat(6, 1fr);\n  grid-gap: 16px;\n  ", " {\n    grid-template-columns: repeat(8, 1fr);\n    grid-gap: 24px;\n  }\n  ", " {\n    grid-template-columns: repeat(12, 1fr);\n    grid-gap: 24px;\n  }\n  ", " {\n    grid-template-columns: repeat(12, 1fr);\n    grid-gap: 32px;\n  }\n"], ["\n  display: grid;\n  grid-template-columns: repeat(6, 1fr);\n  grid-gap: 16px;\n  ", " {\n    grid-template-columns: repeat(8, 1fr);\n    grid-gap: 24px;\n  }\n  ", " {\n    grid-template-columns: repeat(12, 1fr);\n    grid-gap: 24px;\n  }\n  ", " {\n    grid-template-columns: repeat(12, 1fr);\n    grid-gap: 32px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
}, function (_a) {
    var theme = _a.theme;
...
var Dot = styled__default['default'].span(templateObject_2$q || (templateObject_2$q = __makeTemplateObject(["\n  display: ", ";\n  position: absolute;\n  top: 0;\n  right: 0;\n  width: 10px;\n  height: 10px;\n  pointer-events: none;\n  border: 2px solid ", ";\n  border-radius: 50%;\n  background-color: ", ";\n"], ["\n  display: ", ";\n  position: absolute;\n  top: 0;\n  right: 0;\n  width: 10px;\n  height: 10px;\n  pointer-events: none;\n  border: 2px solid ", ";\n  border-radius: 50%;\n  background-color: ", ";\n"])), function (_a) {
    var show = _a.show;
...
var Radio = styled__default['default'].input.attrs({ type: "radio" })(templateObject_1$F || (templateObject_1$F = __makeTemplateObject(["\n  appearance: none;\n  overflow: hidden;\n  cursor: pointer;\n  position: relative;\n  display: inline-block;\n  height: ", ";\n  width: ", ";\n  vertical-align: middle;\n  transition: background-color 0.2s ease-in-out;\n  border: 0;\n  border-radius: 50%;\n  background-color: ", ";\n  box-shadow: ", ";\n\n  &:after {\n    border-radius: 50%;\n    content: \"\";\n    height: ", ";\n    left: 6px;\n    position: absolute;\n    top: 6px;\n    width: ", ";\n  }\n\n  // &:hover:not(:disabled):not(:checked) {\n  //   box-shadow: ", ";\n  // }\n  //\n  // &:focus {\n  //   outline: none;\n  //   box-shadow: ", ";\n  // }\n\n  &:checked {\n    background-color: ", ";\n    &:after {\n      background-color: ", ";\n    }\n  }\n\n  &:disabled {\n    cursor: default;\n    opacity: 0.6;\n  }\n  ", "\n"], ["\n  appearance: none;\n  overflow: hidden;\n  cursor: pointer;\n  position: relative;\n  display: inline-block;\n  height: ", ";\n  width: ", ";\n  vertical-align: middle;\n  transition: background-color 0.2s ease-in-out;\n  border: 0;\n  border-radius: 50%;\n  background-color: ", ";\n  box-shadow: ", ";\n\n  &:after {\n    border-radius: 50%;\n    content: \"\";\n    height: ", ";\n    left: 6px;\n    position: absolute;\n    top: 6px;\n    width: ", ";\n  }\n\n  // &:hover:not(:disabled):not(:checked) {\n  //   box-shadow: ", ";\n  // }\n  //\n  // &:focus {\n  //   outline: none;\n  //   box-shadow: ", ";\n  // }\n\n  &:checked {\n    background-color: ", ";\n    &:after {\n      background-color: ", ";\n    }\n  }\n\n  &:disabled {\n    cursor: default;\n    opacity: 0.6;\n  }\n  ", "\n"])), getScale$1, getScale$1, function (_a) {
    var theme = _a.theme;
    return theme.colors.tertiary;
}, function (_a) {
    var theme = _a.theme;
...
var Bar = styled__default['default'].div(templateObject_1$C || (templateObject_1$C = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  background-color: ", ";\n  height: 16px;\n  transition: width 200ms ease;\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  background-color: ", ";\n  height: 16px;\n  transition: width 200ms ease;\n"])), function (props) { return (props.primary ? props.theme.colors.secondary : props.theme.colors.secondary + "80"); });
Bar.defaultProps = {
    primary: false,
};
...
var ProgressBunnyWrapper = styled__default['default'].div(templateObject_1$B || (templateObject_1$B = __makeTemplateObject(["\n  display: flex;\n  z-index: 2;\n  top: -65%;\n  position: absolute;\n  transform: translate(-50%, -50%);\n  transition: left 200ms ease-out;\n"], ["\n  display: flex;\n  z-index: 2;\n  top: -65%;\n  position: absolute;\n  transform: translate(-50%, -50%);\n  transition: left 200ms ease-out;\n"])));
...
var SliderContainer = styled__default['default'](Box)(templateObject_1$A || (templateObject_1$A = __makeTemplateObject(["\n  position: relative;\n  height: 48px;\n"], ["\n  position: relative;\n  height: 48px;\n"])));
var SliderLabel = styled__default['default'].label(templateObject_2$o || (templateObject_2$o = __makeTemplateObject(["\n  position: absolute;\n  bottom: 0;\n  margin-left: 16px; // offset the bunny butt width\n  left: calc(", "%);\n"], ["\n  position: absolute;\n  bottom: 0;\n  margin-left: 16px; // offset the bunny butt width\n  left: calc(", "%);\n"])), function (_a) {
    var progress = _a.progress;
    return progress;
});
styled__default['default'].img(templateObject_3$g || (templateObject_3$g = __makeTemplateObject(["\n  position: absolute;\n"], ["\n  position: absolute;\n"])));
var BunnySlider = styled__default['default'].div(templateObject_4$b || (templateObject_4$b = __makeTemplateObject(["\n  position: absolute;\n  left: 14px;\n  width: 100%;\n"], ["\n  position: absolute;\n  left: 14px;\n  width: 100%;\n"])));
...
var templateObject_1$A, templateObject_2$o, templateObject_3$g, templateObject_4$b, templateObject_5$a, templateObject_6$7, templateObject_7$4;
...
var Slider = function (_a) {
    ...
    return (React__default['default'].createElement(SliderContainer, __assign({}, props),
        React__default['default'].createElement(Icon$F, { style: { position: "absolute" } }),
...
var float = styled.keyframes(templateObject_2$n || (templateObject_2$n = __makeTemplateObject(["\n\t0% {\n\t\ttransform: translatey(0px);\n\t}\n\t50% {\n\t\ttransform: translatey(10px);\n\t}\n\t100% {\n\t\ttransform: translatey(0px);\n\t}\n"], ["\n\t0% {\n\t\ttransform: translatey(0px);\n\t}\n\t50% {\n\t\ttransform: translatey(10px);\n\t}\n\t100% {\n\t\ttransform: translatey(0px);\n\t}\n"])));
var Container$2 = styled__default['default'].div(templateObject_3$f || (templateObject_3$f = __makeTemplateObject(["\n  position: relative;\n"], ["\n  position: relative;\n"])));
var RotatingPancakeIcon = styled__default['default'](Icon$D)(templateObject_4$a || (templateObject_4$a = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate$1);
var FloatingPanIcon = styled__default['default'](Icon$E)(templateObject_5$9 || (templateObject_5$9 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
...
var templateObject_1$z, templateObject_2$n, templateObject_3$f, templateObject_4$a, templateObject_5$9;
...
var templateObject_1$y, templateObject_2$m, templateObject_3$e, templateObject_4$9, templateObject_5$8;
...
var templateObject_1$x, templateObject_2$l, templateObject_3$d;
...
var Wrapper$g = styled__default['default'].div(templateObject_1$w || (templateObject_1$w = __makeTemplateObject(["\n  display: inline-flex;\n  padding: 4px 12px;\n  background: ", ";\n  color: ", ";\n  border-radius: 16px;\n"], ["\n  display: inline-flex;\n  padding: 4px 12px;\n  background: ", ";\n  color: ", ";\n  border-radius: 16px;\n"])), getBadgeBg, getBadgeColor);
var Badge = function (_a) {
    var children = _a.children, badgeType = _a.badgeType, fontSize = _a.fontSize, fontWeight = _a.fontWeight;
    return (React__default['default'].createElement(Wrapper$g, { badgeType: badgeType },
...
var ModalHeader = styled__default['default'].div(templateObject_2$k || (templateObject_2$k = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  padding: 24px 16px;\n\n  ", " {\n    padding: 32px 32px 24px;\n  }\n  \n  .closeModal {\n    width: 24px;\n    height: 24px;\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  padding: 24px 16px;\n\n  ", " {\n    padding: 32px 32px 24px;\n  }\n  \n  .closeModal {\n    width: 24px;\n    height: 24px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
var ModalTitle = styled__default['default'](Flex)(templateObject_3$c || (templateObject_3$c = __makeTemplateObject(["\n  align-items: center;\n  flex: 1;\n"], ["\n  align-items: center;\n  flex: 1;\n"])));
var ModalBody = styled__default['default'].div(templateObject_4$8 || (templateObject_4$8 = __makeTemplateObject(["\n  padding: 0 16px 24px;\n  \n  ", " {\n    padding: 0 32px 32px;\n  }\n"], ["\n  padding: 0 16px 24px;\n  \n  ", " {\n    padding: 0 32px 32px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
...
var templateObject_1$v, templateObject_2$k, templateObject_3$c, templateObject_4$8;
...
var ModalWrapper = styled__default['default'].div(templateObject_1$t || (templateObject_1$t = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  justify-content: flex-end;\n  align-items: center;\n  position: fixed;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n  z-index: ", ";\n\n  ", " {\n    justify-content: center;\n  }\n"], ["\n  display: flex;\n  flex-direction: column;\n  justify-content: flex-end;\n  align-items: center;\n  position: fixed;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n  z-index: ", ";\n\n  ", " {\n    justify-content: center;\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var Icon$6 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 14 14" }, props),
        React__default['default'].createElement("mask", { id: "mask0", "mask-type": "alpha", maskUnits: "userSpaceOnUse", x: "0", y: "0", width: "14", height: "14" },
            React__default['default'].createElement("circle", { cx: "7", cy: "7", r: "7", fill: "#C4C4C4" })),
        React__default['default'].createElement("g", { mask: "url(#mask0)" },
            React__default['default'].createElement("rect", { y: "-0.00170898", width: "14", height: "14", fill: "url(#pattern0)" }),
            React__default['default'].createElement("rect", { x: "-3", width: "26", height: "14", fill: "url(#pattern1)" })),
        React__default['default'].createElement("defs", null,
            React__default['default'].createElement("pattern", { id: "pattern0", patternContentUnits: "objectBoundingBox", width: "1", height: "1" },
                React__default['default'].createElement("use", { xlinkHref: "#image0", transform: "translate(-0.25) scale(0.00588235)" })),
            React__default['default'].createElement("pattern", { id: "pattern1", patternContentUnits: "objectBoundingBox", width: "1", height: "1" },
                React__default['default'].createElement("use", { xlinkHref: "#image1", transform: "translate(-0.0111977) scale(0.000851996 0.00158228)" })),
            React__default['default'].createElement("image", { id: "image0", width: "255", height: "170", xlinkHref: "data:image/png;base64," }),
            React__default['default'].createElement("image", { id: "image1", width: "1200", height: "632", xlinkHref: "data:image/png;base64," }))));
};
...
var Icon$5 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 14 14" }, props),
        React__default['default'].createElement("mask", { id: "mask0", "mask-type": "alpha", maskUnits: "userSpaceOnUse", x: "0", y: "0", width: "14", height: "14" },
            React__default['default'].createElement("circle", { cx: "7", cy: "7", r: "7", fill: "#C4C4C4" })),
        React__default['default'].createElement("g", { mask: "url(#mask0)" },
            React__default['default'].createElement("rect", { width: "14", height: "14", fill: "url(#pattern0)" })),
        React__default['default'].createElement("defs", null,
            React__default['default'].createElement("pattern", { id: "pattern0", patternContentUnits: "objectBoundingBox", width: "1", height: "1" },
                React__default['default'].createElement("use", { xlinkHref: "#image0", transform: "translate(-0.25) scale(0.00588235)" })),
            React__default['default'].createElement("image", { id: "image0", width: "255", height: "170", xlinkHref: "data:image/png;base64," }))));
...
var Icon$4 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 14 14" }, props),
        React__default['default'].createElement("mask", { id: "mask2", "mask-type": "alpha", maskUnits: "userSpaceOnUse", x: "0", y: "0", width: "14", height: "14" },
            React__default['default'].createElement("circle", { cx: "7", cy: "7", r: "7", fill: "#C4C4C4" })),
        React__default['default'].createElement("g", { mask: "url(#mask2)" },
            React__default['default'].createElement("rect", { width: "14", height: "14", fill: "url(#pattern2)" })),
        React__default['default'].createElement("defs", null,
            React__default['default'].createElement("pattern", { id: "pattern2", patternContentUnits: "objectBoundingBox", width: "1", height: "1" },
                React__default['default'].createElement("use", { xlinkHref: "#image2", transform: "translate(-0.25) scale(0.00125)" })),
            React__default['default'].createElement("image", { id: "image2", width: "1200", height: "800", xlinkHref: "data:image/png;base64," }))));
};
...
var MenuButton = styled__default['default'](Button)(templateObject_1$s || (templateObject_1$s = __makeTemplateObject(["\n  color: ", ";\n  padding: 0 8px;\n  border-radius: 8px;\n  margin-right: 8px;\n\n  ", " {\n    margin-right: 20px;\n  }\n  ", " {\n    display: none;\n  }\n"], ["\n  color: ", ";\n  padding: 0 8px;\n  border-radius: 8px;\n  margin-right: 8px;\n\n  ", " {\n    margin-right: 20px;\n  }\n  ", " {\n    display: none;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.text;
}, function (_a) {
    var theme = _a.theme;
...
var Wrapper$f = styled__default['default'].div(templateObject_1$r || (templateObject_1$r = __makeTemplateObject(["\n  display: ", ";\n  align-items: center;\n  padding: ", ";\n\n  ", " {\n    display: ", ";\n  }\n"], ["\n  display: ", ";\n  align-items: center;\n  padding: ", ";\n\n  ", " {\n    display: ", ";\n  }\n"])), function (_a) {
...
var DropDownWrap$1 = styled__default['default'].div(templateObject_2$j || (templateObject_2$j = __makeTemplateObject(["\n  position: relative;\n"], ["\n  position: relative;\n"])));
var DropDown$2 = styled__default['default'].div(templateObject_3$b || (templateObject_3$b = __makeTemplateObject(["\n  display: none;\n  position: absolute;\n  border-radius: 8px;\n  padding: 8px;\n  background-color: ", ";\n  top: ", ";\n  bottom: ", ";\n  left: ", ";\n  transform: translateX(-50%);\n\n  &:before {\n    display: block;\n    content: \"\";\n    width: 8px;\n    height: 8px;\n    position: absolute;\n    top: ", ";\n    bottom: ", ";\n    left: ", ";\n    transform: translateX(-50%) rotate(45deg);\n    background-color: ", ";\n  }\n\n  &.active {\n    display: block;\n  }\n"], ["\n  display: none;\n  position: absolute;\n  border-radius: 8px;\n  padding: 8px;\n  background-color: ", ";\n  top: ", ";\n  bottom: ", ";\n  left: ", ";\n  transform: translateX(-50%);\n\n  &:before {\n    display: block;\n    content: \"\";\n    width: 8px;\n    height: 8px;\n    position: absolute;\n    top: ", ";\n    bottom: ", ";\n    left: ", ";\n    transform: translateX(-50%) rotate(45deg);\n    background-color: ", ";\n  }\n\n  &.active {\n    display: block;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.dropDown;
}, function (_a) {
    var isSidebar = _a.isSidebar;
...
var DropDownLink$1 = styled__default['default'].a(templateObject_4$7 || (templateObject_4$7 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  width: 100%;\n  font-size: 12px;\n  line-height: 18px;\n  color: ", ";\n  user-select: none;\n  transition: all 0.4s ease;\n\n  &:hover {\n    color: ", ";\n  }\n\n  &:not(:last-child) {\n    margin-bottom: 8px;\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  width: 100%;\n  font-size: 12px;\n  line-height: 18px;\n  color: ", ";\n  user-select: none;\n  transition: all 0.4s ease;\n\n  &:hover {\n    color: ", ";\n  }\n\n  &:not(:last-child) {\n    margin-bottom: 8px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.text;
}, function (_a) {
    var theme = _a.theme;
...
var ItemWrapper = styled__default['default'].div(templateObject_5$7 || (templateObject_5$7 = __makeTemplateObject(["\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  width: 40px;\n  height: 40px;\n  background-color: transparent;\n  border-radius: 8px;\n  margin-right: 8px;\n  transition: all 0.2s;\n\n  &:hover,\n  &.active {\n    background-color: ", ";\n  }\n"], ["\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  width: 40px;\n  height: 40px;\n  background-color: transparent;\n  border-radius: 8px;\n  margin-right: 8px;\n  transition: all 0.2s;\n\n  &:hover,\n  &.active {\n    background-color: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.dropDown;
});
var DropDownLabel$1 = styled__default['default'].span(templateObject_6$6 || (templateObject_6$6 = __makeTemplateObject(["\n  display: block;\n  font-size: 12px;\n  line-height: 18px;\n  color: ", ";\n  margin-bottom: 8px;\n"], ["\n  display: block;\n  font-size: 12px;\n  line-height: 18px;\n  color: ", ";\n  margin-bottom: 8px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.text;
});
var NavSocial = function (_a) {
    ...
    return (React__default['default'].createElement(Wrapper$f, { isPushed: isPushed, isSidebar: isSidebar }, socials.map(function (social) {
        var Icon = Icons$2[social.icon];
        var iconProps = { width: "24px", color: "textSubtle", style: { cursor: "pointer" } };
        if (social.items) {
            return (React__default['default'].createElement(DropDownWrap$1, { key: social.label, ref: ref },
                React__default['default'].createElement(ItemWrapper, { className: "" + (isOpen && "active"), onClick: openDropdown },
                    React__default['default'].createElement(Icon, __assign({}, iconProps))),
                isOpen && (React__default['default'].createElement(DropDown$2, { className: "" + (isOpen && "active"), isSidebar: isSidebar },
                    React__default['default'].createElement(DropDownLink$1, { key: social.items.channel.label, href: social.items.channel.href, "aria-label": social.label },
                        React__default['default'].createElement(Icon$1b, { width: "14px", mr: "8px" }),
                    ...
                    social.items.chats.map(function (item) {
                        ...
                        return (React__default['default'].createElement(DropDownLink$1, { key: item.label, href: item.href, "aria-label": social.label },
...
var templateObject_1$r, templateObject_2$j, templateObject_3$b, templateObject_4$7, templateObject_5$7, templateObject_6$6;

var Wrapper$e = styled__default['default'].div(templateObject_1$q || (templateObject_1$q = __makeTemplateObject(["\n  display: flex;\n  padding-left: 8px;\n\n  ", " {\n    padding-left: 40px;\n  }\n"], ["\n  display: flex;\n  padding-left: 8px;\n\n  ", " {\n    padding-left: 40px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.lg;
});
var HeaderMobileLogo = styled__default['default'].a(templateObject_2$i || (templateObject_2$i = __makeTemplateObject(["\n  align-self: center;\n  overflow: hidden;\n\n  ", " {\n    width: 0;\n    opacity: 0;\n  }\n"], ["\n  align-self: center;\n  overflow: hidden;\n\n  ", " {\n    width: 0;\n    opacity: 0;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.lg;
});
...
var LinkLabel = styled__default['default'].div(templateObject_1$p || (templateObject_1$p = __makeTemplateObject(["\n  color: ", ";\n  transition: color 0.4s;\n  flex-grow: 1;\n"], ["\n  color: ", ";\n  transition: color 0.4s;\n  flex-grow: 1;\n"])), function (_a) {
    var isPushed = _a.isPushed;
    return (isPushed ? "inherit" : "transparent");
});
var MenuEntry = styled__default['default'].div(templateObject_2$h || (templateObject_2$h = __makeTemplateObject(["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: ", "px;\n  padding: ", ";\n  font-size: ", ";\n  color: ", ";\n  border-radius: 8px;\n  background: ", ";\n  height: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n    transition: fill 0.4s;\n  }\n\n  &:hover {\n    color: ", " !important;\n\n    svg {\n      fill: ", " !important;\n    }\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.warning {\n    color: ", ";\n\n    svg {\n      fill: ", ";\n    }\n  }\n\n  &.rainbow {\n    background: ", ";\n    background-size: 400% 100%;\n  }\n"], ["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: ", "px;\n  padding: ", ";\n  font-size: ", ";\n  color: ", ";\n  border-radius: 8px;\n  background: ", ";\n  height: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n    transition: fill 0.4s;\n  }\n\n  &:hover {\n    color: ", " !important;\n\n    svg {\n      fill: ", " !important;\n    }\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.warning {\n    color: ", ";\n\n    svg {\n      fill: ", ";\n    }\n  }\n\n  &.rainbow {\n    background: ", ";\n    background-size: 400% 100%;\n  }\n"])), MENU_ENTRY_HEIGHT, function (_a) {
...
var Container$1 = styled__default['default'].div(templateObject_1$o || (templateObject_1$o = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  // Safari fix\n  flex-shrink: 0;\n"], ["\n  display: flex;\n  flex-direction: column;\n  // Safari fix\n  flex-shrink: 0;\n"])));
...
var Container = styled__default['default'].div(templateObject_1$n || (templateObject_1$n = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  overflow-y: auto;\n  overflow-x: hidden;\n  //height: 100%;\n  flex-grow: 1;\n  padding: ", ";\n  transition: padding-left 0.4s, padding-right 0.4s;\n\n  &::-webkit-scrollbar {\n    width: 0;\n  }\n"], ["\n  display: flex;\n  flex-direction: column;\n  overflow-y: auto;\n  overflow-x: hidden;\n  //height: 100%;\n  flex-grow: 1;\n  padding: ", ";\n  transition: padding-left 0.4s, padding-right 0.4s;\n\n  &::-webkit-scrollbar {\n    width: 0;\n  }\n"])), function (_a) {
    var isPushed = _a.isPushed;
...
var Inner$1 = styled__default['default'].div(templateObject_2$f || (templateObject_2$f = __makeTemplateObject(["\n  padding: 16px;\n  border-radius: 16px;\n  background-color: ", ";\n  height: 143px;\n  overflow: hidden;\n"], ["\n  padding: 16px;\n  border-radius: 16px;\n  background-color: ", ";\n  height: 143px;\n  overflow: hidden;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.dropDown;
});
var PanelFooter2 = function (_a) {
    ...
    //   },
    // ]);
    var isPushed = _a.isPushed, isDark = _a.isDark, footerTitle = _a.footerTitle, deals = _a.deals, dealsForUIKit = _a.dealsForUIKit, showDeals = _a.showDeals;
    // useEffect(()=> {
    //   function newData  () {
    //     setDeals(prevState => [{
    //       dealName: "Liquidity",
    ...
    // },[])
    return (React__default['default'].createElement(Wrapper$d, { isPushed: isPushed, footerTitle: footerTitle, isDark: isDark, deals: deals },
        React__default['default'].createElement(Inner$1, null,
            ...
            React__default['default'].createElement(React__default['default'].Fragment, null, deals && deals.length > 0 &&
                React__default['default'].createElement(React__default['default'].Fragment, null, showDeals &&
                    dealsForUIKit())))));
};
var templateObject_1$m, templateObject_2$f;

var Wrapper$c = styled__default['default'].div(templateObject_1$l || (templateObject_1$l = __makeTemplateObject(["\n  display: none;\n  padding: ", ";\n  transition: padding 0.2s;\n\n  ", " {\n    display: block;\n  }\n"], ["\n  display: none;\n  padding: ", ";\n  transition: padding 0.2s;\n\n  ", " {\n    display: block;\n  }\n"])), function (_a) {
    var isPushed = _a.isPushed;
...
var StyledLink = styled__default['default'](reactRouterDom.Link)(templateObject_2$e || (templateObject_2$e = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  margin-bottom: 32px;\n  \n  .mobile-icon {\n    width: 38px;\n  }\n  .desktop-icon {\n    width: 121px;\n    display: block;\n    margin-left: 8px;\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  margin-bottom: 32px;\n  \n  .mobile-icon {\n    width: 38px;\n  }\n  .desktop-icon {\n    width: 121px;\n    display: block;\n    margin-left: 8px;\n  }\n"])));
    ...
    var innerLogo = (React__default['default'].createElement(React__default['default'].Fragment, null, isPushed ? (React__default['default'].createElement(React__default['default'].Fragment, null,
        ...
        React__default['default'].createElement("defs", null,
            ...
            React__default['default'].createElement("linearGradient", { id: "paint1_linear", x1: "13.0692", y1: "39.8859", x2: "27.193", y2: "-1.0612e-05", gradientUnits: "userSpaceOnUse" },
                React__default['default'].createElement("stop", { offset: "0.00181229", stopColor: "#1158F1" }),
                React__default['default'].createElement("stop", { offset: "1", stopColor: "#119BED" })))))));
    return (React__default['default'].createElement(Wrapper$c, { isPushed: isPushed, isDark: isDark, href: href }, isAbsoluteUrl ? (React__default['default'].createElement(StyledLink, { as: "a", href: href, "aria-label": "Biswap home page" }, innerLogo)) : (React__default['default'].createElement(StyledLink, { to: href, "aria-label": "Biswap home page" }, innerLogo))));
};
...
var PanelWrapper = styled__default['default'].div(templateObject_1$k || (templateObject_1$k = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  position: fixed;\n  padding-top: 64px;\n  left: 0;\n  top: 0;\n  width: ", ";\n  height: -webkit-fill-available;\n  z-index: 30;\n  overflow: ", ";\n  transition: padding-top 0.2s, width 0.2s;\n\n  ", " {\n    width: ", ";\n  }\n  \n  ", " {\n    padding-top: 0;\n    overflow: visible;\n    height: 100vh;\n  }\n  \n  ", " {\n    &:hover .menuBtnDesktop {\n      opacity: 1;\n    }\n  }\n"], ["\n  display: flex;\n  flex-direction: column;\n  position: fixed;\n  padding-top: 64px;\n  left: 0;\n  top: 0;\n  width: ", ";\n  height: -webkit-fill-available;\n  z-index: 30;\n  overflow: ", ";\n  transition: padding-top 0.2s, width 0.2s;\n\n  ", " {\n    width: ", ";\n  }\n  \n  ", " {\n    padding-top: 0;\n    overflow: visible;\n    height: 100vh;\n  }\n  \n  ", " {\n    &:hover .menuBtnDesktop {\n      opacity: 1;\n    }\n  }\n"])), function (_a) {
    var isPushed = _a.isPushed;
...
var StyledPanel = styled__default['default'].div(templateObject_2$d || (templateObject_2$d = __makeTemplateObject(["\n  position: absolute;\n  top: 64px;\n  left: 0;\n  height: calc(100% - 64px);\n  flex-grow: 1;\n  padding-top: 16px;\n  width: ", ";\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  flex-shrink: 0;\n  background-color: ", ";\n  border-right: ", ";\n  transition: padding-top 0.2s, width 0.2s;\n\n  ", " {\n    width: ", ";\n    border-right: 2px solid rgba(133, 133, 133, 0.1);\n  }\n\n  ", " {\n    padding-top: 17px;\n    top: 0;\n    height: 100%;\n  }\n"], ["\n  position: absolute;\n  top: 64px;\n  left: 0;\n  height: calc(100% - 64px);\n  flex-grow: 1;\n  padding-top: 16px;\n  width: ", ";\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  flex-shrink: 0;\n  background-color: ", ";\n  border-right: ", ";\n  transition: padding-top 0.2s, width 0.2s;\n\n  ", " {\n    width: ", ";\n    border-right: 2px solid rgba(133, 133, 133, 0.1);\n  }\n\n  ", " {\n    padding-top: 17px;\n    top: 0;\n    height: 100%;\n  }\n"])), function (_a) {
    var isPushed = _a.isPushed;
    return (isPushed ? SIDEBAR_WIDTH_FULL + "px" : 0);
}, function (_a) {
    var theme = _a.theme;
    ...
    return (React__default['default'].createElement(PanelWrapper, { isPushed: isPushed, showMenu: showMenu },
        React__default['default'].createElement(StyledPanel, { isPushed: isPushed, showMenu: showMenu },
            React__default['default'].createElement(MenuBtnDesktop, { className: "menuBtnDesktop", isPushed: isPushed, onClick: togglePush },
                React__default['default'].createElement(Icon$h, { width: "16px", color: "contrast" })),
            React__default['default'].createElement(Logo$1, { isPushed: isPushed, isDark: isDark, href: href }),
            React__default['default'].createElement(PanelBody, __assign({}, props)),
            deals && (deals === null || deals === void 0 ? void 0 : deals.length) && footerTitle && (React__default['default'].createElement(PanelFooter2, { isPushed: isPushed, showDeals: showDeals, footerTitle: footerTitle, isDark: isDark, dealsForUIKit: dealsForUIKit, deals: deals })),
...
var Wrapper$b = styled__default['default'].a(templateObject_1$j || (templateObject_1$j = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  margin-right: 12px;\n  width: 64px;\n  \n  ", " {\n    margin-right: 32px;\n    width: 94px;\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  margin-right: 12px;\n  width: 64px;\n  \n  ", " {\n    margin-right: 32px;\n    width: 94px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
var AuditInfo = function () {
    return (React__default['default'].createElement(Wrapper$b, { href: 'https://www.certik.org/projects/biswap', target: "_blank" },
...
var StyledSVG = styled__default['default'].svg(templateObject_2$c || (templateObject_2$c = __makeTemplateObject(["\n  animation: 2s ", " linear infinite;\n  height: ", ";\n  width: ", ";\n  path {\n    stroke: ", ";\n  }\n"], ["\n  animation: 2s ", " linear infinite;\n  height: ", ";\n  width: ", ";\n  path {\n    stroke: ", ";\n  }\n"
    /**
...
var Wrapper$a = styled__default['default'].div(templateObject_2$b || (templateObject_2$b = __makeTemplateObject(["\n  max-width: 352px;\n"], ["\n  max-width: 352px;\n"])));
var ConnectModal = function (_a) {
    var login = _a.login, _b = _a.onDismiss, onDismiss = _b === void 0 ? function () { return null; } : _b;
    return (React__default['default'].createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        React__default['default'].createElement(Wrapper$a, null,
...
var TransactionWrapper = styled__default['default'].div(templateObject_2$9 || (templateObject_2$9 = __makeTemplateObject(["\n  border-radius: 16px;\n  padding: 24px;\n  background-color: #F2F6FC;\n"], ["\n  border-radius: 16px;\n  padding: 24px;\n  background-color: #F2F6FC;\n"])));
...
var UserBlock = function (_a) {
    ...
    return (React__default['default'].createElement("div", null, account ? (React__default['default'].createElement(WalletWrap, null,
        React__default['default'].createElement(Button, { variant: pendingTransactions ? "success" : "primary", scale: isSm || isXs ? 'xs' : 'sm', onClick: function () {
            ...
            !isSm && !isXs && (React__default['default'].createElement(Icon$i, __assign({}, iconProps, { mr: "8px" }))),
...
var Top = styled__default['default'].div(templateObject_2$8 || (templateObject_2$8 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  width: 54px;\n  height: 32px;\n  padding: 0 6px;\n  background-color: ", ";\n  cursor: pointer;\n  border-radius: ", ";\n  color: ", ";\n  transition: border-radius .3s ease, background-color .3s ease, color .3s ease;\n\n  ", " {\n    width: 150px;\n    height: 40px;\n    padding: 0 16px;\n  }\n  \n  svg {\n    fill: ", ";\n    width: 20px;\n    margin-right: 4px;\n\n    ", " {\n      width: 24px;\n      margin-right: 8px;\n    }\n  }\n  \n  .arrow {\n    transform: ", ";\n    transition: transform .3s ease;\n    margin-right: 0;\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  width: 54px;\n  height: 32px;\n  padding: 0 6px;\n  background-color: ", ";\n  cursor: pointer;\n  border-radius: ", ";\n  color: ", ";\n  transition: border-radius .3s ease, background-color .3s ease, color .3s ease;\n\n  ", " {\n    width: 150px;\n    height: 40px;\n    padding: 0 16px;\n  }\n  \n  svg {\n    fill: ", ";\n    width: 20px;\n    margin-right: 4px;\n\n    ", " {\n      width: 24px;\n      margin-right: 8px;\n    }\n  }\n  \n  .arrow {\n    transform: ", ";\n    transition: transform .3s ease;\n    margin-right: 0;\n  }\n"])), function (_a) {
    var bg = _a.bg;
    return bg;
}, function (_a) {
...
var TopLabel = styled__default['default'].span(templateObject_3$8 || (templateObject_3$8 = __makeTemplateObject(["\n  font-size: 14px;\n  flex-grow: 1;\n  font-weight: bold;\n  display: none;\n  \n  ", " {\n    display: block;\n  }\n"], ["\n  font-size: 14px;\n  flex-grow: 1;\n  font-weight: bold;\n  display: none;\n  \n  ", " {\n    display: block;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
var DropDown$1 = styled__default['default'].div(templateObject_4$6 || (templateObject_4$6 = __makeTemplateObject(["\n  width: 100%;\n  position: absolute;\n  left: 0;\n  top: 32px;\n  background-color: ", ";\n  border-radius: 0 0 8px 8px;\n  overflow: hidden;\n  z-index: ", ";\n  transform: ", ";\n  transform-origin: top;\n  height: ", ";\n  opacity: ", ";\n  transition: transform .3s ease, opacity .3s ease, height .3s ease;\n\n  ", " {\n    top: 40px;\n  }\n"], ["\n  width: 100%;\n  position: absolute;\n  left: 0;\n  top: 32px;\n  background-color: ", ";\n  border-radius: 0 0 8px 8px;\n  overflow: hidden;\n  z-index: ", ";\n  transform: ", ";\n  transform-origin: top;\n  height: ", ";\n  opacity: ", ";\n  transition: transform .3s ease, opacity .3s ease, height .3s ease;\n\n  ", " {\n    top: 40px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.card;
}, function (_a) {
    var theme = _a.theme;
...
var DropDownItem = styled__default['default'].div(templateObject_5$6 || (templateObject_5$6 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  height: 32px;\n  padding: 0 6px;\n  cursor: pointer;\n  color: ", ";\n  transition: background-color .3s ease;\n\n  ", " {\n    height: 40px;\n    padding: 0 16px;\n  }\n  \n  &:hover {\n    background-color: ", ";\n    color: ", ";\n    \n    svg {\n      fill: ", ";\n    }\n  }\n  \n  svg {\n    width: 20px;\n    margin-right: 0;\n    transition: all .3s ease;\n\n    ", " {\n      width: 24px;\n      margin-right: 8px;\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  height: 32px;\n  padding: 0 6px;\n  cursor: pointer;\n  color: ", ";\n  transition: background-color .3s ease;\n\n  ", " {\n    height: 40px;\n    padding: 0 16px;\n  }\n  \n  &:hover {\n    background-color: ", ";\n    color: ", ";\n    \n    svg {\n      fill: ", ";\n    }\n  }\n  \n  svg {\n    width: 20px;\n    margin-right: 0;\n    transition: all .3s ease;\n\n    ", " {\n      width: 24px;\n      margin-right: 8px;\n    }\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.text;
}, function (_a) {
    var theme = _a.theme;
...
var ItemLabel = styled__default['default'].span(templateObject_6$5 || (templateObject_6$5 = __makeTemplateObject(["\n  display: none;\n  font-size: 14px;\n  flex-grow: 1;\n  font-weight: bold;\n  transition: color .3s ease;\n\n  ", " {\n    display: block;\n  }\n"], ["\n  display: none;\n  font-size: 14px;\n  flex-grow: 1;\n  font-weight: bold;\n  transition: color .3s ease;\n\n  ", " {\n    display: block;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
var NetworkSwitcher = function (_a) {
    ...
    return (React__default['default'].createElement(Wrapper$9, { ref: containerRef },
        React__default['default'].createElement(Top, { bg: selectedOption.bg, onClick: toggling, isOpen: isOpen },
            ...
            React__default['default'].createElement(Icon$1l, { width: "24px", color: "contrast", className: "arrow" })),
        React__default['default'].createElement(DropDown$1, { ref: dropdownRef, isOpen: isOpen }, options.map(function (option) {
...
var templateObject_1$d, templateObject_2$8, templateObject_3$8, templateObject_4$6, templateObject_5$6, templateObject_6$5;
...
var Label = styled__default['default'].span(templateObject_1$b || (templateObject_1$b = __makeTemplateObject(["\n  font-size: 14px;\n  color: ", ";\n  margin-right: 4px;\n  font-weight: 400;\n"], ["\n  font-size: 14px;\n  color: ", ";\n  margin-right: 4px;\n  font-weight: 400;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.contrast;
});
var ConnectMetamask = function (props) {
    ...
    return (React__default['default'].createElement(Button, { scale: "sm", variant: "primary", width: "100%", maxWidth: "142px", onClick: function () { return onClick(); }, as: "button" },
        ...
        React__default['default'].createElement(Icon$19, { width: "22px" })));
};
var templateObject_1$b;
...
var InfoList = styled__default['default'].div(templateObject_3$7 || (templateObject_3$7 = __makeTemplateObject(["\n  flex-grow: initial;\n\n  ", " {\n    flex-grow: 1;\n  }\n"], ["\n  flex-grow: initial;\n\n  ", " {\n    flex-grow: 1;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.xll;
});
var InfoListItem = styled__default['default'].div(templateObject_4$5 || (templateObject_4$5 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  line-height: 18px;\n  \n  &:not(:last-child) {\n    margin-bottom: 8px;\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  line-height: 18px;\n  \n  &:not(:last-child) {\n    margin-bottom: 8px;\n  }\n"])));
var InfoListLabel = styled__default['default'].span(templateObject_5$5 || (templateObject_5$5 = __makeTemplateObject(["\n  font-size: 12px;\n  width: 120px;\n  min-width: 120px;\n  color: ", ";\n  font-weight: bold;\n"], ["\n  font-size: 12px;\n  width: 120px;\n  min-width: 120px;\n  color: ", ";\n  font-weight: bold;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.text;
});
var InfoListValue = styled__default['default'].span(templateObject_6$4 || (templateObject_6$4 = __makeTemplateObject(["\n  font-size: 12px;\n  color: ", ";\n  padding-left: 4px;\n  font-weight: bold;\n"], ["\n  font-size: 12px;\n  color: ", ";\n  padding-left: 4px;\n  font-weight: bold;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.contrast;
});
var FooterInfo = function (_a) {
    var BSWPriceLabel = _a.BSWPriceLabel, BSWPriceValue = _a.BSWPriceValue, onClick = _a.onClick, footerStatistic = _a.footerStatistic;
...
var templateObject_1$a, templateObject_2$7, templateObject_3$7, templateObject_4$5, templateObject_5$5, templateObject_6$4;

var Wrapper$6 = styled__default['default'].div(templateObject_1$9 || (templateObject_1$9 = __makeTemplateObject(["\n  grid-area: about;\n"], ["\n  grid-area: about;\n"])));
var TopAction$2 = styled__default['default'].div(templateObject_2$6 || (templateObject_2$6 = __makeTemplateObject(["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 16px;\n"], ["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 16px;\n"])));
var Title$4 = styled__default['default'].h4(templateObject_3$6 || (templateObject_3$6 = __makeTemplateObject(["\n  font-size: 16px;\n  color: ", ";\n"], ["\n  font-size: 16px;\n  color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.contrast;
});
var ActionIcon$2 = styled__default['default'].div(templateObject_4$4 || (templateObject_4$4 = __makeTemplateObject(["\n  width: 14px;\n  height: 14px;\n  position: relative;\n  display: block;\n  \n  ", " {\n    display: none;\n  }\n  \n  &:before,\n  &:after {\n    display: block;\n    content: \"\";\n    width: 14px;\n    height: 2px;\n    background-color: ", ";\n    position: absolute;\n    left: 50%;\n    top: 50%;\n    transition: transform 0.3s ease;\n  }\n  \n  &:before {\n    transform: ", ";\n  }\n  \n  &:after {\n    transform: ", ";\n  }\n"], ["\n  width: 14px;\n  height: 14px;\n  position: relative;\n  display: block;\n  \n  ", " {\n    display: none;\n  }\n  \n  &:before,\n  &:after {\n    display: block;\n    content: \"\";\n    width: 14px;\n    height: 2px;\n    background-color: ", ";\n    position: absolute;\n    left: 50%;\n    top: 50%;\n    transition: transform 0.3s ease;\n  }\n  \n  &:before {\n    transform: ", ";\n  }\n  \n  &:after {\n    transform: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
}, function (_a) {
    var theme = _a.theme;
...
var NavList$2 = styled__default['default'].div(templateObject_5$4 || (templateObject_5$4 = __makeTemplateObject(["\n  overflow: hidden;\n  transform: ", ";\n  transform-origin: top;\n  height: ", ";\n  opacity: ", ";\n  transition: transform .3s ease, opacity .3s ease, height .3s ease;\n  padding-bottom: ", ";\n\n  ", " {\n    padding-bottom: 0;\n    height: auto;\n    opacity: 1;\n    transform: scaleY(1);\n  }\n"], ["\n  overflow: hidden;\n  transform: ", ";\n  transform-origin: top;\n  height: ", ";\n  opacity: ", ";\n  transition: transform .3s ease, opacity .3s ease, height .3s ease;\n  padding-bottom: ", ";\n\n  ", " {\n    padding-bottom: 0;\n    height: auto;\n    opacity: 1;\n    transform: scaleY(1);\n  }\n"])), function (_a) {
    var isOpen = _a.isOpen;
    return isOpen ? 'scaleY(1)' : 'scaleY(0)';
}, function (_a) {
...
var CustomLink$2 = styled__default['default'](MenuLink)(templateObject_7$3 || (templateObject_7$3 = __makeTemplateObject(["\n  transition: opacity .3s ease;\n\n  &:hover {\n    opacity: .65;\n  }\n"], ["\n  transition: opacity .3s ease;\n\n  &:hover {\n    opacity: .65;\n  }\n"])));
var About = function (_a) {
    ...
    return (React__default['default'].createElement(Wrapper$6, null,
        React__default['default'].createElement(TopAction$2, { onClick: function () { return setIsOpen(!isOpen); } },
            React__default['default'].createElement(Title$4, null, "About Us"),
...
var TopAction$1 = styled__default['default'].div(templateObject_2$5 || (templateObject_2$5 = __makeTemplateObject(["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 16px;\n"], ["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 16px;\n"])));
var Title$3 = styled__default['default'].h4(templateObject_3$5 || (templateObject_3$5 = __makeTemplateObject(["\n  font-size: 16px;\n  color: ", ";\n"], ["\n  font-size: 16px;\n  color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.contrast;
});
var ActionIcon$1 = styled__default['default'].div(templateObject_4$3 || (templateObject_4$3 = __makeTemplateObject(["\n  width: 14px;\n  height: 14px;\n  position: relative;\n  display: block;\n\n  ", " {\n    display: none;\n  }\n\n  &:before,\n  &:after {\n    display: block;\n    content: \"\";\n    width: 14px;\n    height: 2px;\n    background-color: ", ";\n    position: absolute;\n    left: 50%;\n    top: 50%;\n    transition: transform 0.3s ease;\n  }\n\n  &:before {\n    transform: ", ";\n  }\n\n  &:after {\n    transform: ", ";\n  }\n"], ["\n  width: 14px;\n  height: 14px;\n  position: relative;\n  display: block;\n\n  ", " {\n    display: none;\n  }\n\n  &:before,\n  &:after {\n    display: block;\n    content: \"\";\n    width: 14px;\n    height: 2px;\n    background-color: ", ";\n    position: absolute;\n    left: 50%;\n    top: 50%;\n    transition: transform 0.3s ease;\n  }\n\n  &:before {\n    transform: ", ";\n  }\n\n  &:after {\n    transform: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
}, function (_a) {
    var theme = _a.theme;
...
var NavList$1 = styled__default['default'].div(templateObject_5$3 || (templateObject_5$3 = __makeTemplateObject(["\n  overflow: hidden;\n  transform: ", ";\n  transform-origin: top;\n  height: ", ";\n  opacity: ", ";\n  transition: transform .3s ease, opacity .3s ease, height .3s ease;\n  padding-bottom: ", ";\n\n  ", " {\n    padding-bottom: 0;\n    height: auto;\n    opacity: 1;\n    transform: scaleY(1);\n  }\n"], ["\n  overflow: hidden;\n  transform: ", ";\n  transform-origin: top;\n  height: ", ";\n  opacity: ", ";\n  transition: transform .3s ease, opacity .3s ease, height .3s ease;\n  padding-bottom: ", ";\n\n  ", " {\n    padding-bottom: 0;\n    height: auto;\n    opacity: 1;\n    transform: scaleY(1);\n  }\n"])), function (_a) {
    var isOpen = _a.isOpen;
    return isOpen ? 'scaleY(1)' : 'scaleY(0)';
}, function (_a) {
    var isOpen = _a.isOpen, innerHeight = _a.innerHeight;
...
var CustomLink$1 = styled__default['default'](MenuLink)(templateObject_7$2 || (templateObject_7$2 = __makeTemplateObject(["\n  transition: opacity .3s ease;\n\n  &:hover {\n    opacity: .65;\n  }\n"], ["\n  transition: opacity .3s ease;\n\n  &:hover {\n    opacity: .65;\n  }\n"])));
var Product = function (_a) {
    ...
    return (React__default['default'].createElement(Wrapper$5, null,
        React__default['default'].createElement(TopAction$1, { onClick: function () { return setIsOpen(!isOpen); } },
            React__default['default'].createElement(Title$3, null, "Product"),
...
var TopAction = styled__default['default'].div(templateObject_2$4 || (templateObject_2$4 = __makeTemplateObject(["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 16px;\n"], ["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 16px;\n"])));
var Title$2 = styled__default['default'].h4(templateObject_3$4 || (templateObject_3$4 = __makeTemplateObject(["\n  font-size: 16px;\n  color: ", ";\n"], ["\n  font-size: 16px;\n  color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.contrast;
});
var ActionIcon = styled__default['default'].div(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  width: 14px;\n  height: 14px;\n  position: relative;\n  display: block;\n\n  ", " {\n    display: none;\n  }\n\n  &:before,\n  &:after {\n    display: block;\n    content: \"\";\n    width: 14px;\n    height: 2px;\n    background-color: ", ";\n    position: absolute;\n    left: 50%;\n    top: 50%;\n    transition: transform 0.3s ease;\n  }\n\n  &:before {\n    transform: ", ";\n  }\n\n  &:after {\n    transform: ", ";\n  }\n"], ["\n  width: 14px;\n  height: 14px;\n  position: relative;\n  display: block;\n\n  ", " {\n    display: none;\n  }\n\n  &:before,\n  &:after {\n    display: block;\n    content: \"\";\n    width: 14px;\n    height: 2px;\n    background-color: ", ";\n    position: absolute;\n    left: 50%;\n    top: 50%;\n    transition: transform 0.3s ease;\n  }\n\n  &:before {\n    transform: ", ";\n  }\n\n  &:after {\n    transform: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
}, function (_a) {
    var theme = _a.theme;
...
var NavList = styled__default['default'].div(templateObject_5$2 || (templateObject_5$2 = __makeTemplateObject(["\n  overflow: hidden;\n  transform: ", ";\n  transform-origin: top;\n  height: ", ";\n  opacity: ", ";\n  transition: transform .3s ease, opacity .3s ease, height .3s ease;\n  padding-bottom: ", ";\n\n  ", " {\n    padding-bottom: 0;\n    height: auto;\n    opacity: 1;\n    transform: scaleY(1);\n  }\n"], ["\n  overflow: hidden;\n  transform: ", ";\n  transform-origin: top;\n  height: ", ";\n  opacity: ", ";\n  transition: transform .3s ease, opacity .3s ease, height .3s ease;\n  padding-bottom: ", ";\n\n  ", " {\n    padding-bottom: 0;\n    height: auto;\n    opacity: 1;\n    transform: scaleY(1);\n  }\n"])), function (_a) {
    var isOpen = _a.isOpen;
    return isOpen ? 'scaleY(1)' : 'scaleY(0)';
}, function (_a) {
    var isOpen = _a.isOpen, innerHeight = _a.innerHeight;
...
var CustomLink = styled__default['default'](MenuLink)(templateObject_7$1 || (templateObject_7$1 = __makeTemplateObject(["\n  transition: opacity .3s ease;\n\n  &:hover {\n    opacity: .65;\n  }\n"], ["\n  transition: opacity .3s ease;\n\n  &:hover {\n    opacity: .65;\n  }\n"])));
...
var Title$1 = styled__default['default'].h4(templateObject_2$3 || (templateObject_2$3 = __makeTemplateObject(["\n  font-size: 16px;\n  color: ", ";\n  margin-bottom: 16px;\n"], ["\n  font-size: 16px;\n  color: ", ";\n  margin-bottom: 16px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.contrast;
});
var SocialWrap = styled__default['default'].div(templateObject_3$3 || (templateObject_3$3 = __makeTemplateObject(["\n  display: flex;\n  margin: 0 -4px;\n"], ["\n  display: flex;\n  margin: 0 -4px;\n"])));
var SocialItem = styled__default['default'].div(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  width: 20px;\n  height: 20px;\n  margin: 0 4px;\n  transition: opacity .3s ease;\n  \n  &:hover {\n    opacity: .65;\n  }\n"], ["\n  width: 20px;\n  height: 20px;\n  margin: 0 4px;\n  transition: opacity .3s ease;\n  \n  &:hover {\n    opacity: .65;\n  }\n"])));
var DropDownWrap = styled__default['default'].div(templateObject_5$1 || (templateObject_5$1 = __makeTemplateObject(["\n  position: relative;\n"], ["\n  position: relative;\n"])));
var DropDown = styled__default['default'].div(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  display: none;\n  position: absolute;\n  border-radius: 8px;\n  padding: 8px;\n  background-color: ", ";\n  bottom: 32px;\n  left: 100%;\n  transform: translateX(-40%);\n\n  &:before {\n    display: block;\n    content: \"\";\n    width: 8px;\n    height: 8px;\n    position: absolute;\n    bottom: -4px;\n    left: 22px;\n    transform: translateX(-50%) rotate(45deg);\n    background-color: ", ";\n  }\n\n  &.active {\n    display: block;\n  }\n"], ["\n  display: none;\n  position: absolute;\n  border-radius: 8px;\n  padding: 8px;\n  background-color: ", ";\n  bottom: 32px;\n  left: 100%;\n  transform: translateX(-40%);\n\n  &:before {\n    display: block;\n    content: \"\";\n    width: 8px;\n    height: 8px;\n    position: absolute;\n    bottom: -4px;\n    left: 22px;\n    transform: translateX(-50%) rotate(45deg);\n    background-color: ", ";\n  }\n\n  &.active {\n    display: block;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.dropDown;
}, function (_a) {
    var theme = _a.theme;
...
var DropDownLink = styled__default['default'].a(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  width: 100%;\n  font-size: 12px;\n  line-height: 18px;\n  color: ", ";\n  user-select: none;\n  transition: all 0.4s ease;\n\n  &:hover {\n    color: ", ";\n  }\n\n  &:not(:last-child) {\n    margin-bottom: 8px;\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  width: 100%;\n  font-size: 12px;\n  line-height: 18px;\n  color: ", ";\n  user-select: none;\n  transition: all 0.4s ease;\n\n  &:hover {\n    color: ", ";\n  }\n\n  &:not(:last-child) {\n    margin-bottom: 8px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.text;
}, function (_a) {
    var theme = _a.theme;
...
var DropDownLabel = styled__default['default'].span(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  display: block;\n  font-size: 12px;\n  line-height: 18px;\n  color: ", ";\n  margin-bottom: 8px;\n"], ["\n  display: block;\n  font-size: 12px;\n  line-height: 18px;\n  color: ", ";\n  margin-bottom: 8px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.text;
});
        ...
        React__default['default'].createElement(SocialWrap, null, socials.map(function (social) {
            ...
            if (social.items) {
                return (React__default['default'].createElement(DropDownWrap, { key: social.label, ref: ref },
                    React__default['default'].createElement(SocialItem, { className: "" + (isOpen && "active"), onClick: openDropdown },
                        React__default['default'].createElement(Icon, __assign({}, iconProps))),
                    isOpen && (React__default['default'].createElement(DropDown, { className: "" + (isOpen && "active") },
...
var Title = styled__default['default'].h4(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["\n  font-size: 16px;\n  color: ", ";\n  margin-bottom: 16px;\n"], ["\n  font-size: 16px;\n  color: ", ";\n  margin-bottom: 16px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.contrast;
});
...
var Suport = function () {
    return (React__default['default'].createElement(Wrapper$2, null,
        ...
        React__default['default'].createElement(LinkBtn, { href: "https://t.me/biswap", target: "_blank" },
            "Contact in",
            React__default['default'].createElement(Icon$p, { width: "24px", color: "contrast", ml: "4px" }))));
};
...
styled__default['default'](Button)(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n  grid-area: btnUp;\n  display: none;\n\n  ", " {\n    display: inline-flex;\n    margin-left: 12px;\n  }\n"], ["\n  grid-area: btnUp;\n  display: none;\n\n  ", " {\n    display: inline-flex;\n    margin-left: 12px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.xll;
});
var Footer = function (_a) {
    var isPushed = _a.isPushed, BSWPriceLabel = _a.BSWPriceLabel, BSWPriceValue = _a.BSWPriceValue, onClick = _a.onClick, footerStatistic = _a.footerStatistic, aboutLinks = _a.aboutLinks, productLinks = _a.productLinks, serviceLinks = _a.serviceLinks;
    return (React__default['default'].createElement(Wrapper$1, { isPushed: isPushed },
        React__default['default'].createElement(InnerRow, null,
            React__default['default'].createElement(FooterInfo, { BSWPriceLabel: BSWPriceLabel, BSWPriceValue: BSWPriceValue, onClick: onClick, footerStatistic: footerStatistic }),
    ...
    return (React__default['default'].createElement(Wrapper, { className: "" + (isPushed ? "no-scroll" : "") },
        React__default['default'].createElement(BodyWrapper, null,
            React__default['default'].createElement(StyledNav, { showMenu: showMenu, isPushed: isPushed, menuBg: menuBg },
                ...
                React__default['default'].createElement(Flex, { alignItems: "center" },
                    ...
                    React__default['default'].createElement(NetworkSwitcher, { options: [
                            {
                                label: 'Polygon',
                                icon: React__default['default'].createElement(Icon$8, { className: "icon" }),
                                value: 137,
                                bg: '#8046E3',
                            },
                            {
                                label: 'BSC',
                                icon: React__default['default'].createElement(Icon$7, { className: "icon" }),
                                value: 56,
                                bg: '#F0B90B',
                            },
            ...
            React__default['default'].createElement(Inner, { isPushed: isPushed, showMenu: showMenu },
                ...
                React__default['default'].createElement(Footer, { BSWPriceLabel: BSWPriceLabel, BSWPriceValue: BSWPriceValue, footerStatistic: footerStatistic, isPushed: isPushed, onClick: onClick, aboutLinks: aboutLinks, productLinks: productLinks, serviceLinks: serviceLinks })),
