...
var MenuBtnDesktop = styled__default['default'].div(templateObject_2$a || (templateObject_2$a = __makeTemplateObject(["\n  display: none;\n  justify-content: center;\n  align-items: center;\n  width: 24px;\n  height: 24px;\n  border-radius: 50%;\n  background-color: ", ";\n  cursor: pointer;\n  position: absolute;\n  top: 24px;\n  right: -12px;\n  transform: ", ";\n\n  ", " {\n    display: flex;\n    opacity: ", ";\n    transition: opacity 0.3s ease;\n  }\n"], ["\n  display: none;\n  justify-content: center;\n  align-items: center;\n  width: 24px;\n  height: 24px;\n  border-radius: 50%;\n  background-color: ", ";\n  cursor: pointer;\n  position: absolute;\n  top: 24px;\n  right: -12px;\n  transform: ", ";\n\n  ", " {\n    display: flex;\n    opacity: ", ";\n    transition: opacity 0.3s ease;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.dropDown;
}, function (_a) {
    var isPushed = _a.isPushed;
...
var AccountModal = function (_a) {
    ...
    var _c = React.useState(recentTransaction), transactions = _c[0]; _c[1];
    ...
    var getRowStatus = function (sortedRecentTransaction) {
        ...
        if (!hash) {
            return { icon: React__default['default'].createElement(Icon$7, null), color: 'text' };
        }
        if (hash && (receipt === null || receipt === void 0 ? void 0 : receipt.status) === 1) {
            return { icon: React__default['default'].createElement(Icon$1w, { color: "success" }), color: 'success' };
        }
        return { icon: React__default['default'].createElement(Icon$1v, { color: "failure" }), color: 'failure' };
    };
    ...
    return (React__default['default'].createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        ...
        React__default['default'].createElement(TransactionWrapper, null,
            React__default['default'].createElement(Flex, { justifyContent: 'space-between', alignItems: 'center' },
                ...
                React__default['default'].createElement(Button, { scale: 'sm', variant: 'text', onClick: function () { return clearTransaction(); } }, "Clear All")),
            React__default['default'].createElement(React__default['default'].Fragment, null,
...
var useWalletModal = function (login, logout, account, recentTransaction, chainId, clearTransaction) {
    ...
    var onPresentAccountModal = useModal(React__default['default'].createElement(AccountModal, { login: login, recentTransaction: recentTransaction, chainId: chainId, account: account || "", logout: logout, clearTransaction: clearTransaction }))[0];
        ...
        React__default['default'].createElement(BodyWrapper, null,
            React__default['default'].createElement(StyledNav, { showMenu: showMenu, isPushed: isPushed, menuBg: menuBg },
                ...
                React__default['default'].createElement(Flex, null,
                    ...
                    React__default['default'].createElement(UserBlock, { clearTransaction: clearTransaction, account: account, login: login, logout: logout, recentTransaction: recentTransaction, chainId: chainId, pendingTransactions: pendingTransactions }))),
